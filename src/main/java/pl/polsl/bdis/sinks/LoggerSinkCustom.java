...
public class LoggerSinkCustom extends AbstractSink implements Configurable {

    private static final Logger logger = LoggerFactory
            .getLogger(org.apache.flume.sink.LoggerSink.class);

    // Default Max bytes to dump
    public static final int DEFAULT_MAX_BYTE_DUMP = 256;
        ...
        try {
            ...
            if (event != null) {
                if (logger.isInfoEnabled()) {
                    logger.info("Event: " + new String(event.getBody(), StandardCharsets.UTF_8));
                }
            } else {
